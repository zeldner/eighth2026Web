...
type ZodValidatorFailureBody<T$1 extends ZodSchema> = T$1 extends v4.$ZodType ? Extract<ZodSafeParseResult<v4.output<T$1>>, {
  success: false;
}> : T$1 extends v3.ZodType ? Extract<v3.SafeParseReturnType<v3.input<T$1>, v3.output<T$1>>, {
  success: false;
}> : never;
type ZodValidatorFailureResponse<T$1 extends ZodSchema> = Response & TypedResponse<ZodValidatorFailureBody<T$1>, 400, "json">;
...
type ValidationFunctionOption<T$1 extends ZodSchema, Target extends keyof ValidationTargets> = {
...
declare function zValidatorFunction<T$1 extends ZodSchema, Target extends keyof ValidationTargets, E extends Env, P extends string, In = zInput<T$1>, Out = zOutput<T$1>, I extends Input = DefaultInput<Target, In, Out>, V extends I = I>(target: Target, schema: T$1, hook?: undefined, options?: ValidationFunctionOption<T$1, Target>): MiddlewareHandler<E, P, V, ZodValidatorFailureResponse<T$1>>;
declare function zValidatorFunction<T$1 extends ZodSchema, Target extends keyof ValidationTargets, E extends Env, P extends string, HookFn extends Hook<InferredValue, E, P, Target, {}, T$1>, In = zInput<T$1>, Out = zOutput<T$1>, I extends Input = DefaultInput<Target, In, Out>, V extends I = I, InferredValue = zInfer<T$1>>(target: Target, schema: T$1, hook?: HookFn, options?: ValidationFunctionOption<T$1, Target>): MiddlewareHandler<E, P, V, ExtractValidationResponse<HookFn>>;
